        ...
        //int use=Integer.parseInt(user);
            ...
            if(action.toLowerCase().equals("delete"))
            {
               ...
               int i = ps.executeUpdate();
                ...
                response.sendRedirect("/project-4-master/adminpage?pagei=user_update&ud=udd");
                }
                
            }
            else if(action.toLowerCase().equals("update"))
            {
                PreparedStatement ps=con.prepareStatement("update customer set HOUSEHOLD_ID=?,SECRET_ANSWER=? ,TYPE=? where CUSTOMER_ID=?");
